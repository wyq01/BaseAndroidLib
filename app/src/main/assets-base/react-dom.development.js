...
\outl0\strokewidth0 \strokec2 /** @license React v16.4.0\
...
// can be mutated and processed asynchronously before it is committed \'e2\'80\'94 a form\
...
function enqueueUpdate(fiber, update, expirationTime) \{\
  ...
  \} else \{\
    ...
    // while accounting for the persistent structure of the list \'e2\'80\'94 we don't\
...
\
/**\
 * The "base" render time is the duration of the \'e2\'80\'9cbegin\'e2\'80\uc0\u157  phase of work for a particular fiber.\
    ...
    \{\
      if (returnFiber.mode & StrictMode) \{\
        ...
        if (!didWarnAboutStringRefInStrictMode[componentName]) \{\
          warning_1(false, 'A string ref, "%s",\'c2\'a0has been found within a strict mode tree. ' + 'String refs are a source of potential bugs and should be avoided. ' + 'We recommend using createRef() instead.' + '\\n%s' + '\\n\\nLearn more about using refs safely here:' + '\\nhttps://fb.me/react-strict-mode-string-ref', mixedRef, getStackAddendumByWorkInProgressFiber(returnFiber));\
