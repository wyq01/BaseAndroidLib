...
import kotlinx.android.synthetic.main.act_basic_input.*

class BasicInputAct : BaseActivity() {
    ...
    override fun initViews() {
        ...
        enterBtn.click {
            ...
            if (url.isEmpty()) {
                ...
                BasicAct.startActivity(this, url)
        ...
        printBtn.click {
            BasicPrintTestAct.startActivity(this)
        }
        changeScreenOrientationBtn.click {
            changeScreenOrientation()
        }
        webTestBtn.click {
            BasicAct.startActivity(this, "file:///android_asset/web_test.html")
        }
    ...
    override fun initLayout(): Int {
        return R.layout.act_basic_input
    }
