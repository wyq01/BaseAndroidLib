...
class CommonShapeButton @JvmOverloads constructor(
     ...
     * 填充颜色
     */
    private var mFillColor : ColorStateList?
    ...
    init {
        context.obtainStyledAttributes(attrs, R.styleable.CommonShapeButton).apply {
            ...
            mFillColor = getColorStateList(R.styleable.CommonShapeButton_csb_fillColor)
            if (mFillColor == null) {
                mFillColor = ColorStateList.valueOf(0xFF3183FB.toInt())
            }
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        with(normalGradientDrawable) {
            if (mStartColor != 0xFFFFFFFF.toInt() && mEndColor != 0xFFFFFFFF.toInt()) { // 渐变色
...
//                }
    ...
    private fun getCornerRadiusByPosition(): FloatArray {
        ...
        if (containsFlag(mCornerPosition,
                TOP_LEFT
            )) {
