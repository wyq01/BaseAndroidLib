...
import com.ts.base.printer.bean.BasePrint
import com.ts.base.printer.bean.PrintBean
...
import com.ts.base.util.ScreenRotateUtils
...
abstract class BaseActivity : BaseAbstractActivity() {
     ...
     * 是否覆盖状态栏
     */
    protected open fun overStatusBar(): Boolean {
        return false
    }
            ...
            .onGranted {
                ...
                if (selfPermission) {
                    ...
                    ToastUtil.shortToast(this,
                        R.string.base_permission_denied
                    )
                }
            }
