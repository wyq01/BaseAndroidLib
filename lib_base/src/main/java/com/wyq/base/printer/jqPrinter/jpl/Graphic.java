...
public class Graphic extends BaseJPL {
    ...
    public boolean line(int startX, int startY, int endX, int endY, int width,
                        JPL.COLOR color) throws IOException {
        _cmd[0] = 0x1A;
        _cmd[1] = 0x5C;
        _cmd[2] = 0x01;
        _cmd[3] = (byte) startX;
    ...
    public boolean line(int startX, int startY, int endX, int endY, int width) throws IOException {
        return line(startX, startY, endX, endY, width, JPL.COLOR.Black);
    }

    public boolean line(int startX, int startY, int endX, int endY) throws IOException {
        _cmd[0] = 0x1A;
        _cmd[1] = 0x5C;
        _cmd[2] = 0x00;
        _cmd[3] = (byte) startX;
    ...
    public boolean rect(int left, int top, int right, int bottom) throws IOException {
        _cmd[0] = 0x1A;
        _cmd[1] = 0x26;
        _cmd[2] = 0x00;
        _cmd[3] = (byte) left;
    ...
    public boolean rect(int left, int top, int right, int bottom, int width, JPL.COLOR color) throws IOException {
        _cmd[0] = 0x1A;
        _cmd[1] = 0x26;
        _cmd[2] = 0x01;
        _cmd[3] = (byte) left;
    ...
    public boolean rectFill(int left, int top, int right, int bottom, JPL.COLOR color) throws IOException {
        _cmd[0] = 0x1A;
        _cmd[1] = 0x2A;
        _cmd[2] = 0x00;
        _cmd[3] = (byte) left;
