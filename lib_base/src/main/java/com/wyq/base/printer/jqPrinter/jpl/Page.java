...
public class Page extends BaseJPL {
     ...
     * 打印页面开始
     */
    public boolean start(int originX, int originY, int pageWidth, int pageHeight, PAGE_ROTATE rotate) throws IOException {
     ...
     * 当前页面重复打印几次
     */
    public boolean print(int count) throws IOException {
        _cmd[0] = 0x1A;
        _cmd[1] = 0x4F;
        _cmd[2] = 0x01;
        _cmd[3] = (byte) count;
