package com.wyq.base.printer.jqPrinter.port;
...
public class Port {
    ...
    public boolean writeNULL() throws IOException {
        _cmd[0] = 0;
        return write(_cmd, 0, 1);
    }

    public boolean write(char[] data, int offset, int length, int size) throws IOException {
        if (size == 1) {
