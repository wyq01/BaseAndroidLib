...
public class Barcode extends BaseJPL {
     ...
     *一维条码绘制
     */
    private boolean _1D_barcode(int x, int y, BAR_1D_TYPE type, int height, BAR_UNIT unit_width, BAR_ROTATE rotate, String text) throws IOException {
        _cmd[0] = 0x1A;
        _cmd[1] = 0x30;
        _cmd[2] = 0x00;
        _cmd[3] = (byte) x;
     ...
     * code128
     */
    public boolean code128(int x, int y, int bar_height, BAR_UNIT unit_width, BAR_ROTATE rotate, String text) throws IOException {
     ...
     */
    public boolean code128(Printer_define.ALIGN align, int startX, int endX, int y, int bar_height, BAR_UNIT unit_width, BAR_ROTATE rotate, String text) throws IOException {
        if (endX < startX) {
            int temp = startX;
            startX = endX;
            endX = temp;
    ...
    public boolean QRCode(int x, int y, int version, QRCODE_ECC ecc,
                          BAR_UNIT unit_width, JPL.ROTATE rotate, String text) throws IOException {
        _cmd[0] = 0x1A;
        _cmd[1] = 0x31;
        _cmd[2] = 0x00;
        _cmd[3] = (byte) version;
     ...
     */
    public boolean QRCode(int x, int y, int version, QRCODE_ECC ecc,
                          BAR_UNIT unit_width, JPL.ROTATE rotate, byte[] data, int datasize) throws IOException {
        _cmd[0] = 0x1A;
        _cmd[1] = 0x31;
        _cmd[2] = 0x10;
        _cmd[3] = (byte) version;
    ...
    public boolean DataMatrix(int x, int y, BAR_UNIT unit_width, JPL.ROTATE rotate,
    ...
    public boolean GridMatrix(int x, int y, byte ecc, BAR_UNIT unit_width, JPL.ROTATE rotate, String text) throws IOException {
        _cmd[0] = 0x1A;
        _cmd[1] = 0x31;
        _cmd[2] = 0x03;
        _cmd[3] = (byte) ecc;
