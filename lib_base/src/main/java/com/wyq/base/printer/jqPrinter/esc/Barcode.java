...
public class Barcode extends BaseESC {
     ...
     * 设置1维条码高度
     */
    public boolean set1DHeight(int height) throws IOException {
        _cmd[0] = 0x1D;
        _cmd[1] = 0x68;
        _cmd[2] = (byte) height;
     ...
     * 设置1维，2维条码基本单元大小
     */
    public boolean setUnit(ESC.BAR_UNIT unit) throws IOException {
        _cmd[0] = 0x1D;
        _cmd[1] = 0x77;
     ...
     * 设置条码文字位置
     */
    public boolean setTextPosition(ESC.BAR_TEXT_POS pos) throws IOException {
        _cmd[0] = 0x1D;
        _cmd[1] = 0x48;
     ...
     * 设置条码文字大小
     */
    public boolean setTextSize(ESC.BAR_TEXT_SIZE size) throws IOException {
        _cmd[0] = 0x1D;
        _cmd[1] = 0x66;
     ...
     */
    private boolean UPCE_base(byte[] data, int offset, int length) throws IOException {
        _cmd[0] = 0x1D;
        _cmd[1] = 0x6B;
        _cmd[2] = 0x01;
     ...
     * --String str：必须7个字符
     */
    public boolean UPCE_auto(String text) throws IOException {
        byte[] buf = new byte[9];
     ...
     */
    private boolean UPCA_base(byte[] data, int offset, int length) throws IOException {
        _cmd[0] = 0x1D;
        _cmd[1] = 0x6B;
        _cmd[2] = 0x00;
        _port.write(_cmd, 0, 3);
     ...
     * --String str：必须11个字符
     */
    public boolean UPCA_auto(String str) throws IOException {
     ...
     */
    private boolean EAN13_base(byte[] data, int offset, int length) throws IOException {
        _cmd[0] = 0x1D;
        _cmd[1] = 0x6B;
        _cmd[2] = 0x03;
        _port.write(_cmd, 0, 3);
     ...
     * --String str：必须12个字符
     */
    public boolean EAN13_auto(String str) throws IOException {
     ...
     */
    private boolean EAN8_base(byte[] data, int offset, int length) throws IOException {
        _cmd[0] = 0x1D;
        _cmd[1] = 0x6B;
        _cmd[2] = 0x02;
        _port.write(_cmd, 0, 3);
     ...
     * --String str：必须7个字符
     */
    public boolean EAN8_auto(String str) throws IOException {
        if (str.length() != 7)
            return false;
        for (int i = 0; i < str.length(); i++) // 检查是否为数字
        {
     ...
     */
    private boolean CODE128_base(byte[] data, int offset, int length) throws IOException {
        _cmd[0] = 0x1D;
        _cmd[1] = 0x6B;
        _cmd[2] = 0x08;
        _port.write(_cmd, 0, 3);
     ...
     * --String str：
     */
    public boolean CODE128_auto(String str) throws IOException {
     ...
     * Code128自动计算校验和
     */
    public boolean code128_auto_drawOut(Printer_define.ALIGN align, ESC.BAR_UNIT unit, int height, ESC.BAR_TEXT_POS pos, ESC.BAR_TEXT_SIZE size, String str) throws IOException {
        Code128 code128 = new Code128(str);
        byte[] buf = code128.encode_data;
        if (buf == null)
            return false;
    ...
    public boolean code128_auto_printOut(Printer_define.ALIGN align, ESC.BAR_UNIT unit, int height, ESC.BAR_TEXT_POS pos, ESC.BAR_TEXT_SIZE size, String str) throws IOException {
    ...
    /// <returns></returns>
    public boolean barcode2D_SetType(ESC_BAR_2D type) throws IOException {
        _cmd[0] = 0x1D;
        _cmd[1] = 0x5A;
    ...
    /// <returns></returns>
    public boolean barcode2D_DrawOut(byte m, byte n, byte k, String text) throws IOException {
        byte[] data = null;
        try {
    ...
    /// <returns></returns>
    public boolean barcode2D_QRCode(byte version, byte ecc, String text) throws IOException {
    ...
    /// <param name="text">条码内容</param>
    /// <returns></returns>
    public boolean barcode2D_QRCode(int x, int y, ESC.BAR_UNIT unit, int version, int ecc, String text) throws IOException {
        this.setXY(x, y);
        this.setUnit(unit);
        barcode2D_SetType(ESC_BAR_2D.QRCODE);
    ...
    /// <param name="text">条码内容</param>
    /// <returns></returns>
    public boolean barcode2D_PDF417(byte columnNumber, byte ecc, byte hwratio, String text) throws IOException {
    ...
    /// <param name="text">条码内容</param>
    /// <returns></returns>
    public boolean barcode2D_DATAMatrix(String text) throws IOException {
    ...
    /// <param name="text">条码内容</param>
    /// <returns></returns>
    public boolean barcode2D_GRIDMatrix(byte ecc, String text) throws IOException {
        barcode2D_SetType(ESC_BAR_2D.GRIDMATIX);
        return barcode2D_DrawOut(ecc, (byte) 0, (byte) 0, text);
    }

    public boolean printQRCode(int x, int y, ESC.BAR_UNIT unit, int version, int ecc, String text) throws IOException {
        clearParams();
        this.setXY(x, y);
        this.setUnit(unit);
        barcode2D_SetType(ESC_BAR_2D.QRCODE);
    ...
    public boolean printQRCode(ESC.BAR_UNIT unit, int version, int ecc, String text) throws IOException {
        clearParams();
        this.setUnit(unit);
        barcode2D_SetType(ESC_BAR_2D.QRCODE);
        return barcode2D_DrawOut((byte) version, (byte) ecc, (byte) 0, text);
    ...
    public boolean printQRCode(Printer_define.ALIGN align, ESC.BAR_UNIT unit, int version, int ecc, String text) throws IOException {
        clearParams();
        setAlign(align);
        this.setUnit(unit);
        barcode2D_SetType(ESC_BAR_2D.QRCODE);
