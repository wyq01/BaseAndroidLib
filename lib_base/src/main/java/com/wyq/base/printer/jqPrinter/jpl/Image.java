...
public class Image extends BaseJPL {
    ...
    public boolean drawOut(int x, int y, int width, int height, char[] data) throws IOException {
        if (width < 0 || height < 0)
            return false;
    ...
    public boolean drawOut(int x, int y, int width, int height, byte[] data,
                           boolean Reverse, IMAGE_ROTATE Rotate, int EnlargeX, int EnlargeY) throws IOException {
        if (width < 0 || height < 0)
            return false;
        int WidthByte = ((width - 1) / 8 + 1);
    ...
    public boolean drawOut(int x, int y, Resources res, int id,
                           IMAGE_ROTATE rotate) throws IOException {
