...
public class MonthPickerView extends LinearLayout implements NumberPickerView.OnValueChangeListener {
    ...
    private void initInternal(Context context) {
        View contentView = inflate(context, R.layout.base_view_month_picker, this);
    ...
    public DateData getCalendarData() {
        ...
        if (!mIsGregorian) {
            long ymd = pickedYear * 10000 + pickedMonthSway * 100 + 1;
            isOutOfDate = ymd > 21001201;
        }
        return new DateData(pickedYear, pickedMonthSway, 1, mIsGregorian);
    }
