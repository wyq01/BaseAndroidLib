 ...
 * Date: 2018/10/9
 */
class MultiChooseListDialog private constructor(
    context: Context,
    ...
    internal inner class FilterAdapter(data: ArrayList<String>, selectedList: ArrayList<Int>?) :
        ...
        override fun convert(helper: ViewHolder, item: String) {
            ...
            helper.checkIv.visibility = if (selectedMap.containsKey(helper.layoutPosition)) View.VISIBLE else View.INVISIBLE
        }
...
//        filterRv.itemAnimator?.changeDuration = 0
    ...
    class Builder(private val context: Context) {
        ...
        fun create(): MultiChooseListDialog {
            return MultiChooseListDialog(
                context,
                data,
                selectedList,
                titleStr,
